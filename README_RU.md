...
# Привет!👋
Меня зовут Артур Изланов, я Data Scientist и аналитик данных с фокусом на машинное обучение и предиктивную аналитику.

## 👤 О себе
Люблю превращать сырые цифры в понятные и полезные инструменты для бизнеса. 
- Мне нравится разбираться в сути задач, оптимизировать процессы и облегчать жизнь коллег.
- Помимо аналитики и дашбордов, активно погружаюсь в Data Science: строю предиктивные модели, прогнозирую тренды и оптимизирую процессы с помощью ML.
- Ценю понятную коммуникацию, живой подход к делу и всегда открыт к интересным задачам и проектам.
